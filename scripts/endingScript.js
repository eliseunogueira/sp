...
var numOfConj;
if (lessonLanguage == 'French' || lessonLanguage == 'German') {
  numOfConj = 6;
} else {
  numOfConj = 7;
}
...
///GERMAN EDIT
if (lessonLanguage == 'German' && conjNum >= 4) {
  //iF GERMAN FUTURE OR CONDITIONAL
  for (var numE = 1; numE <= numOfConj; numE++) {
    var sideInput = window['forConj' + conjNum][numE - 1].split('<strong>');
    sideInput = sideInput[1].split('</strong>');
    sideInput = sideInput[0];
...
function skipConj() {
  if (picControl != 'picPrev') {
    ...
    if (currentMinusNarr != 0) {
      //GERMAN EDIT
      if (lessonLanguage == 'German' && lessonNumber == 126) {
        $('#conjItem0').html(
      ...
      } else if (lessonLanguage == 'German' && lessonNumber == 127) {
        $('#conjItem0').html(
          capitalFirst(replaceText2[verbInList - 1]) +
    ...
    for (var num = 1; num <= window['forConj' + theConj].length; num++) {
      if (num == 1 && lessonLanguage == 'French') {
        ...
        //GERMAN EDIT
        if (lessonLanguage == 'German' && conjNum >= 4) {
          var tempZ = window['forConj' + theConj][num - 1].split('zzzz');
          $('#conjItem' + num).append(tempZ[0] + ' + infinitive');
        } else if (lessonLanguage == 'German' && lessonNumber == 127) {
          $('#conjItem' + num).append(
            window['forConj' + theConj][num - 1].replace(
              'zzzz',
              replaceText[verbInList - 1],
            ) +
              ' ' +
      ...
      ///PORTUGUESE CHANGE START REPLACE	!!!! WARNING
...
function changeWord() {
  ...
  if (residual == 0) {
    if (picControl != 'picPrev') {
      ...
      for (var num = 1; num <= window['forConj' + theConj].length; num++) {
        if (num == 1 && lessonLanguage == 'French') {
          ...
          if (lessonLanguage == 'German' && lessonNumber == 127) {
            $('#conjItem' + num).append(
              window['forConj' + theConj][num - 1].replace(
                'zzzz',
                replaceText[verbInList - 1],
    ...
    if (lessonLanguage == 'German' && conjNum >= 4) {
      $('.forSentence').html(
        capitalFirst(replaceText[verbInList - 1]) + verbType.toLowerCase(),
      );
    } else if (lessonLanguage == 'German' && lessonNumber == 126) {
      $('.forSentence').html(
        capitalFirst(replaceText2[verbInList - 1]) +
          '<strong>' +
          verbType.toLowerCase() +
    ...
    if (lessonLanguage == 'German' && lessonNumber == 127) {
      $('.forSentence').html(
        window['forConj' + theConj][residual - 1].replace(
          'zzzz',
          replaceText[verbInList - 1],
        ) +
          ' ' +
    ...
    $('#conjAnimation')
      .stop()
      .animate({ left: newPos.left + 'px', top: newPos.top + 'px' }, 1500);
    ...
    //GERMAN EDIT
    if (lessonLanguage == 'German' && conjNum >= 4 && verbInList == 1) {
      var tempZ = window['forConj' + theConj][residual - 1].split('zzzz');
      $('.forSentence').html(tempZ[0] + ' + infinitive');
    } else if (lessonLanguage == 'German' && lessonNumber == 127) {
      $('.forSentence').html(
        window['forConj' + theConj][residual - 1].replace(
          'zzzz',
...
$(document).ready(function () {
  ...
  ///PORTUGUESE CHANGE END
    ...
    $('#starConjSame, .starQuestion, .starQuestion2, .lineJoiner').hide();
    if (conjNum == 3 && lessonLanguage == 'German') {
      $('#quizBtn2').hide();
    }
    $('#starConjWarn').html(
...
function loadQuiz2() {
  ...
  quizNumQues = 18;
  if (conjNum > 2 && lessonLanguage == 'German') {
    quizNumQues = 6;
  }
  if (errorMode == true) {
...
function loadQuiz3() {
  ...
  if (conjNum == 3 && lessonLanguage == 'German') {
    forExamples = [];
    for (var numX = 0; numX < numOfConj; numX++) {
      forExamples.push(forConjQuiz[numX].replace('zzzz', replaceText[3]));
    }
    for (var numX = 0; numX < numOfConj; numX++) {
      forExamples.push(forConjQuiz[numX].replace('zzzz', replaceText[4]));
    }
    for (var numX = 0; numX < numOfConj; numX++) {
      forExamples.push(forConjQuiz[numX].replace('zzzz', replaceText[5]));
    }
  }

  ///GERMAN EDIT
  if (lessonLanguage == 'French') {
    if (vowels.indexOf(replaceText[3].charAt(0)) != -1) {
      forExamples[0] = forExamples[0].replace("je/j' ", "j'");
    } else {
      forExamples[0] = forExamples[0].replace("je/j' ", 'je ');
    }
    if (vowels.indexOf(replaceText[4].charAt(0)) != -1) {
      forExamples[6] = forExamples[6].replace("je/j' ", "j'");
    } else {
      forExamples[6] = forExamples[6].replace("je/j' ", 'je ');
    }
    if (vowels.indexOf(replaceText[5].charAt(0)) != -1) {
...
function quizActions2() {
  ...
  ///2020 EXTRA
  if (extraTime == false) {
    if (currQuizNum == 7 || currQuizNum == 13) {
      extraTime = true;
...
function placePuzzle() {
  ...
  if (lessonLanguage == 'German' && lessonNumber == 126) {
    var infVerb =
      capitalFirst(replaceText2[currentVerb]) +
      '<strong>' +
      verbType.toLowerCase() +
      '</strong>';
  } else if (lessonLanguage == 'German' && lessonNumber == 127) {
  ...
  //GERMAN EDIT
  if (lessonLanguage == 'German' && lessonNumber == 127) {
    $('#puzzle1A').val(allQuizEndings[0] + ' ' + replaceText2[currentVerb]);
    $('#puzzle2A').val(allQuizEndings[1] + ' ' + replaceText2[currentVerb]);
    $('#puzzle3A').val(allQuizEndings[2] + ' ' + replaceText2[currentVerb]);
    $('#puzzle4A').val(allQuizEndings[3] + ' ' + replaceText2[currentVerb]);
    $('#puzzle5A').val(allQuizEndings[4] + ' ' + replaceText2[currentVerb]);
    $('#puzzle6A').val(allQuizEndings[5] + ' ' + replaceText2[currentVerb]);
    $('#puzz1BText').text(allQuizEndings[0] + ' ' + replaceText2[currentVerb]);
    $('#puzz2BText').text(allQuizEndings[1] + ' ' + replaceText2[currentVerb]);
    $('#puzz3BText').text(allQuizEndings[2] + ' ' + replaceText2[currentVerb]);
    $('#puzz4BText').text(allQuizEndings[3] + ' ' + replaceText2[currentVerb]);
    $('#puzz5BText').text(allQuizEndings[4] + ' ' + replaceText2[currentVerb]);
    $('#puzz6BText').text(allQuizEndings[5] + ' ' + replaceText2[currentVerb]);
  }
  ///END GERMAN EDIT
  setTimeout(function () {
    resizeQuiz();
...
function quizActions3() {
  ...
  if (conjNum > 2 && lessonLanguage == 'German') {
    theQuizWord = forExamples[quizQuesNum - 1].split('<strong>');
    var quizWordFind = theQuizWord[1].split('</strong>');
    quizWord = quizWordFind[0];
    writtenString = quizWord;
    $('#quizSentenceFor').html(
      theQuizWord[0] +
        "<strong style='font-family: Arial, Helvetica, sans-serif;'>" +
...
function startLesson() {
  ...
  for (var numE = 1; numE <= numOfConj; numE++) {
    $('#sideEnding' + numE).text(allEndings[numE - 1]);
